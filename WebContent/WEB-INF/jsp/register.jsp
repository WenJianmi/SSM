...
<form method="post" name="reg" action="saveCustomer">
	<table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
		...
		<tr>
			...
			<input id =username maxLength="8" size="32" name="name" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">
			<span id="message"><font color="#FF0000">*</font></span></td>
		</tr>
		<tr>
		...
		<tr>
		 ...
		 <tr>
			...
			<input type="text" size="32" name="city" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">市/县</td>
		</tr> 
		<tr>
...
<!-- 		<tr>
		...
		<tr>
			...
			<input id="confirm" type="button" value="注 册" onclick="javascript:checkReg()">&nbsp;&nbsp;&nbsp;<input type="reset" name="reset" value="清 除"></td>
		</tr>
	</table>
</form>
<!--文件尾开始-->
...
<script type="text/javascript">
	$("#username").blur(function(){
		if($("#username").val()==""){
			$("#message").html("<font color=\"#FF0000\">用户名不能为空</font>");
			$("#confirm").attr("disabled","disabled");
		}else{
		var url="<%=basePath %>checkname/"+$("#username").val();
		$.getJSON(
		url,function(data){
			if(data.status==200){
				$("#message").html("<font color=\"#FF0000\">"+data.data+"</font>");
